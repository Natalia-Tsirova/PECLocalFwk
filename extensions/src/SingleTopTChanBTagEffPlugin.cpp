#include <SingleTopTChanBTagEffPlugin.hpp>
...
SingleTopTChanBTagEffPlugin::SingleTopTChanBTagEffPlugin(string const &outDirectory_):
    Plugin("SingleTopBTagEff"), outDirectory(outDirectory_)
{
...
Plugin *SingleTopTChanBTagEffPlugin::Clone() const
{
    return new SingleTopTChanBTagEffPlugin(outDirectory);
}


void SingleTopTChanBTagEffPlugin::BeginRun(Dataset const &dataset)
{
...
void SingleTopTChanBTagEffPlugin::EndRun()
{
...
bool SingleTopTChanBTagEffPlugin::ProcessEvent()
{
