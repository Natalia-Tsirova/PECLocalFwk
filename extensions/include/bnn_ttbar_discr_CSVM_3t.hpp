 ...
 * 
 * Sun Aug 25 04:08:03 2013
 * 
 * 
 * The list of input variables:
 *  var #0: log(glb_PtJ1)
 *  var #1: glb_Sphericity
 *  var #2: log(glb_SqrtSHat)
 *  var #3: abs(thq_EtaLJet)
 *  var #4: thq_CosLepLJetTH
 *  var #5: log(thq_MassHiggs)
 *  var #6: log(thq_PtHiggs)
 *  var #7: tt_DeltaRLightJets
 *  var #8: log(tt_MassTopHad)
 *  var #9: log(tt_MassWHad)
 *  var #10: log(tt_MaxMassBHadQ)
 * 
 * From the code below, the user is expected to only use the class BNN.
 ******************************************************************************/


#ifndef TTBAR_DISCR_CSVM_3T_HPP
#define TTBAR_DISCR_CSVM_3T_HPP
...
class NN
{
	...
	public:
		void SetWeightsL1(Double_t const [15][11]);
...
{	 public:
	...
	public:
		...
		Double_t operator()(Double_t var0, Double_t var1, Double_t var2, Double_t var3, Double_t var4, Double_t var5, Double_t var6, Double_t var7, Double_t var8, Double_t var9, Double_t var10) const;
